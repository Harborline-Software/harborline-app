...
/// <summary>
/// Represents the head revision of a report definition.
/// </summary>
...
/// <param name="ReportKind">The report kind.</param>
...
/// <summary>
/// Represents the full detail of a report definition's head revision.
/// </summary>
/// <param name="Key">The stable report-definition key.</param>
/// <param name="Version">The head version.</param>
/// <param name="Title">The report title.</param>
...
/// <summary>
/// Represents a report definition's retained versions and their ordering rule.
/// </summary>
...
public sealed record ReportVersionList(string Ordering, IReadOnlyList<ReportDefinitionSummary> Versions);

/// <summary>
/// Represents a reports administration request failure.
/// </summary>
...
public sealed class ReportsAdminException(
    int status,
    string message,
    string? code = null,
