...
export interface ReportDefinitionDetailProps {
  readonly definition: ReportDefinitionSummary
  readonly detail: ReportDefinitionDetailModel | null
  readonly versionList: ReportVersionList | null
  readonly errorLine?: string | null
}

export function ReportDefinitionDetail({ definition, detail, versionList, errorLine }: ReportDefinitionDetailProps) {
  return (
    <div>
      <dl>
        ...
        <dt>Kind</dt><dd>{definition.reportKind}</dd>
            ...
            <TableBody>
              {versionList.versions.map(row => (
                <TableRow key={row.version}>
                  ...
                  <TableCell>{row.reportKind}</TableCell>
